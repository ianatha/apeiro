...
const _: () = {
    assert!(core::mem::size_of::<RawBytes>() == core::mem::size_of::<bytes::Bytes>(),);
    assert!(core::mem::align_of::<RawBytes>() == core::mem::align_of::<bytes::Bytes>(),);
};
...
mod tests {
    ...
    unsafe fn static_clone(_: &AtomicPtr<()>, ptr: *const u8, len: usize) -> bytes::Bytes {
